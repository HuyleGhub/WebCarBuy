                        ...
                        {donHangs.map((donHang) => (
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(donHang.TrangThaiDonHang)}`}>
                                        {donHang.TrangThaiDonHang}
                                    </span>
                                </div>

                                {donHang.ChiTietDonHang.map((chiTiet) => (
                                    <div key={chiTiet.idChiTietDonHang} className="flex items-center gap-4 border-t pt-4">
                                        <div className="w-24 h-24 flex-shrink-0">
                                            <img
                                                src={chiTiet.xe.HinhAnh}
                                                alt={chiTiet.xe.TenXe}
                                                className="w-full h-full object-cover rounded-lg"
                                            />
                                        </div>
                                        <div className="flex-1">
                                            <h3 className="font-semibold text-lg mb-1">{chiTiet.xe.TenXe}</h3>
                                            <p className="text-gray-600 mb-1">Màu sắc: <span>{chiTiet.xe.MauSac}</span></p>
                                        ...
                                        <div className="text-right">
                                            <p className="text-sm text-gray-600">Số lượng: {chiTiet.SoLuong}</p>
                                        </div>
                                    </div>
                                ))}
